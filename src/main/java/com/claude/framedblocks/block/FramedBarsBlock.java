...
/**
 * Framed bars (iron-bars-like thin panes). The connection logic comes from
 * vanilla {@link IronBarsBlock}; the multipart blockstate assembles a centre
 * post plus one side pane per connection, each retextured with the camo.
 */
public class FramedBarsBlock extends IronBarsBlock implements EntityBlock {
	public FramedBarsBlock(BlockBehaviour.Properties props) {
		super(props);
	}
