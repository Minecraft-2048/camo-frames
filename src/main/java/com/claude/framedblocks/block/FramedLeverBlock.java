...
public class FramedLeverBlock extends LeverBlock implements EntityBlock {
	public FramedLeverBlock(BlockBehaviour.Properties props) {
		super(props);
	}
	...
	protected InteractionResult useWithoutItem(BlockState state, Level level, BlockPos pos,
		...
		// Fall through to vanilla lever toggle.
