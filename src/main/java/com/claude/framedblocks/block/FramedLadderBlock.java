...
/**
 * Climbable framed ladder. Wall attachment, popping when the wall breaks and
 * waterlogging all come from vanilla {@link LadderBlock}; climbability comes
 * from the {@code minecraft:climbable} block tag.
 */
public class FramedLadderBlock extends LadderBlock implements EntityBlock {
	public FramedLadderBlock(BlockBehaviour.Properties props) {
		super(props);
	}
