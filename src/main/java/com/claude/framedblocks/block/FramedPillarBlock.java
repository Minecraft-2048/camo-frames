...
/** Centered 8x8 pillar, orientable along any axis like a log. */
public class FramedPillarBlock extends RotatedPillarBlock implements EntityBlock {
	...
	public FramedPillarBlock(BlockBehaviour.Properties props) {
		super(props);
	}
